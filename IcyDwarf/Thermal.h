...
//					((*Mrock)[ir] + (*Mh2os)[ir] + (*Mh2ol)[ir])/(4.0/3.0*PI_greek*(pow((*r)[ir+1],3.0)-pow((*r)[ir],3.0)))/(1.0-(*pore)[ir]), ((*Mrock)[ir] + (*Mh2os)[ir] + (*Mh2ol)[ir])/((*Vrock)[ir] + (*Vh2os)[ir] + (*Vh2ol)[ir]), (*pore)[ir], (*Erock)[ir], (*Eh2os)[ir], (*Eslush)[ir]);
//		}
	}
